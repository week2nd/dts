...
<body>
	...
	<input type="submit" value="선수 등록"> 
		...
		<table class="table">
			...
			<tr>
				<td><input type="text" name="nickname" value="${player.nickname}" placeholder="소환사명만 입력하세요"> </td>
				<td><input type="text" name="name" value="${player.name}" placeholder="선수명을 입력하세요"></td>
