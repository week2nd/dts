	...
	<div align="center">
		<table class="table">
			...
			<tr>
				...
				<td><input type="text" name="bluepick1" value="${match.bluepick1}" size="10" placeholder="블루 픽1"></td>
				<td><input type="text" name="bluepick2" value="${match.bluepick2}" size="10" placeholder="블루 픽2"></td>
				<td><input type="text" name="bluepick3" value="${match.bluepick3}" size="10" placeholder="블루 픽3"></td>
				<td><input type="text" name="bluepick4" value="${match.bluepick4}" size="10" placeholder="블루 픽4"></td>
				<td><input type="text" name="bluepick5" value="${match.bluepick5}" size="10" placeholder="블루 픽5"></td>
				<td></td>
				<td><input type="text" name="playtime" value="${match.playtime}" size="10" placeholder="##:##"></td>
				<td></td>
				<td><input type="text" name="redpick5" value="${match.redpick5}" size="10" placeholder="레드 픽1"></td>
				<td><input type="text" name="redpick4" value="${match.redpick4}" size="10" placeholder="레드 픽2"></td>
				<td><input type="text" name="redpick3" value="${match.redpick3}" size="10" placeholder="레드 픽3"></td>
				<td><input type="text" name="redpick2" value="${match.redpick2}" size="10" placeholder="레드 픽4"></td>
				<td><input type="text" name="redpick1" value="${match.redpick1}" size="10" placeholder="레드 픽5"></td>
				<td align="center" colspan="2">PICK</td>
			</tr>
			<tr>
