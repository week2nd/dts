...
<input type="text" name="gameId">
	<div align="center">
		<table class="table">
			...
			<tr>
				<td colspan="6"><input type="text" name="blueTeamName" size="10" placeholder="블루팀명"></td>
				<td align="center" colspan="2"><input type="text" name="blueResult" size="10" placeholder="블루팀 결과"></td>
				<td> 　:</td>
				<td align="center" colspan="2"><input type="text" name="redResult" size="10" placeholder="레드팀 결과"></td>
				<td align="right" colspan="6"><input type="text" name="redTeamName" size="10" placeholder="레드팀명"></td>
			</tr>
			<tr>
				<td>K</td>
				<td><input type="text" name="bluePick1Kill" value="0" size="10" placeholder="블루팀 처치합계"></td>
				<td>D</td>
				<td><input type="text" name="bluePick1Death" value="0" size="10" placeholder="블루팀 죽음합계"></td>
				<td>A</td>
				<td><input type="text" name="bluePick1Assist" value="0" size="10" placeholder="블루팀 지원합계"></td>
				<td>KDA</td>
				<td>#.#</td>
				<td>Play Time</td>
				<td>K</td>
				<td><input type="text" name="redPick1Kill" value="0" size="10" placeholder="레드팀 처치합계"></td>
				<td>D</td>
				<td><input type="text" name="redPick1Death" value="0" size="10" placeholder="레드팀 죽음합계"></td>
				<td>A</td>
				<td><input type="text" name="redPick1Assist" value="0" size="10" placeholder="레드팀 지원합계"></td>
				<td>KDA</td>
				<td>#.#</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td><input type="text" name="blueBan1" size="10" placeholder="블루 벤1"></td>
				<td><input type="text" name="blueBan2" size="10" placeholder="블루 벤2"></td>
				<td><input type="text" name="blueBan3" size="10" placeholder="블루 벤3"></td>
				<td><input type="text" name="blueBan4" size="10" placeholder="블루 벤4"></td>
				<td><input type="text" name="blueBan5" size="10" placeholder="블루 벤5"></td>
				<td></td>
				<td></td>
				<td></td>
				<td><input type="text" name="redBan5" size="10" placeholder="레드 벤1"></td>
				<td><input type="text" name="redBan4"  size="10" placeholder="레드 벤2"></td>
				<td><input type="text" name="redBan3"  size="10" placeholder="레드 벤3"></td>
				<td><input type="text" name="redBan2"  size="10" placeholder="레드 벤4"></td>
				<td><input type="text" name="redBan1" size="10" placeholder="레드 벤5"></td>
				<td align="center" colspan="2">BAN</td>
			</tr>
			<tr>
