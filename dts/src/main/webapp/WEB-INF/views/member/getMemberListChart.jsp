    ...
    function drawChart() {
    	...
    	$.ajax({
    		...
    		success: function(data){
    			...
    			for(var i=0; i<dlistslength; i++){
    				
    				myArray.push([ data[i].MON,data[i].CNT ]);
    			}
    			myArray1.push(myArray);
    		}
    	});
		console.log(myArray1);
    	
    	 var data = google.visualization.arrayToDataTable( myArray1 );
...
<div id="columnchart_material" style="width: 800px; height: 500px;" onclick="ajaxData()"></div>
