 ...
 <form action="deleteMemberList" >	
	...
	<table border="1">
		<tr style="border-radius:20px;">
			...
			<th style="width:7%;">마일리지<a href="#" onclick="go_sort('u_mileage')">▲</a></th>
			<th style="width:6%;">권한<a href="#" onclick="go_sort('u_grant')">▲</a></th>
			<th style="width:7%;">생년월일<a href="#" onclick="go_sort('u_birth')">▲</a></th>
			<th style="width:7%;">가입일<a href="#" onclick="go_sort('u_date')">▲</a></th>
